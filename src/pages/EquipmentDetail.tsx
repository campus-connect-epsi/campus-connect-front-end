...
const EquipmentDetail = () => {
  ...
  const equipment = {
    ...
    status: "Disponible",
    description:
      "Perceuse sans fil professionnelle avec 2 batteries lithium-ion. Idéale pour percer dans le bois, métal et béton. Couple de serrage réglable et éclairage LED intégré.",
    specifications: {
      Puissance: "18V",
      "Couple max": "46 Nm",
      Mandrin: "1.5-13 mm",
  ...
  const reviews = [
    ...
    },
    {
      ...
      rating: 4,
      comment:
        "Bonne perceuse, batterie qui tient bien. Quelques signes d'usure mais fonctionne parfaitement.",
      date: "2024-06-15",
    },
  ];
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2 text-muted-foreground">
                  ...
                  <span>
                    Disponible jusqu'au{" "}
                    {new Date(equipment.availableUntil).toLocaleDateString("fr-FR")}
                  </span>
                </div>
