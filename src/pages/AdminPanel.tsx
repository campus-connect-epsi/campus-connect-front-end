...
const AdminPanel = () => {
  ...
  const eventsList = [
    ...
    {
      id: 2,
      name: "Hackathon Développement Durable",
      date: "2024-07-20",
      attendees: 45,
      status: "Complet",
    },
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="text-sm">
                      <span className="font-medium">Marie D.</span> a réservé une perceuse
                      électrique
                  ...
                  {eventsList.map((event) => (
                    ...
                    >
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          {new Date(event.date).toLocaleDateString("fr-FR")} • {event.attendees}{" "}
                          participants
                        </div>
                      </div>
                      <div className="flex items-center space-x-3">
